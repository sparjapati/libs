...
class VendorApiLogMappingTest {
    ...
    @Test fun `entity toDto maps all fields`() {
        val entity = VendorApiLogEntity(
            id = 1L, apiName = "STRIPE", requestId = "req-1", attemptId = "attempt-1",
        ...
        assertEquals("attempt-1", dto.attemptId)
    ...
    @Test fun `log toEntity maps all fields`() {
        val log = VendorApiLog(
            apiName = "STRIPE", requestId = "req-2", attemptId = "attempt-2", httpMethod = "GET",
            url = "https://y.com",
        ...
        assertEquals("attempt-2", entity.attemptId)

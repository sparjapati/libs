 ...
 *
 * The header name is resolved per-API via [com.sparjapati.vendorClient.VendorApiKey.traceHeader],
 * falling back to [VendorClientSettings.requestIdHeader] when the API has no override or when
 * the request method has no [@TraceableApi][com.sparjapati.vendorClient.annotation.TraceableApi]
 * annotation.
 *
